...
export default function Home() {
  ...
  return (
    <main>
      ...
      {chatOpen && <Chat onClose={() => toggleChat(false)}/>} 
    </main>
  );
}
...
function Chat({ onClose }) {
  ...
  async function send(e) {
    ...
    if ((!text && !file) || busy || !hydrated) return;
